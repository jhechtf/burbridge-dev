...
export const classNames = cva('border transition-all', {
	variants: {
		color: {
			primary:
				'bg-emerald-800 border-emerald-800 text-slate-50 hover:bg-emerald-700 hover:border-emerald-700',
			'primary:inverse':
				'bg-emerald-300 text-zinc-800 border-emerald-300 hover:bg-emerald-400 hover:border-emerald-400',
...
export interface ButtonProps
	extends Omit<React.HTMLAttributes<HTMLButtonElement>, 'color'>, ClassVariants {}
